//  Note: THis file is created by copying the contents of tasks.swift and then adding in
//  just the changes for Task 0. The purpose is to have a way to validate that after the
//  student completes Task 0 the project will compile and properly report the status of
//  all tasks.
//
//  Tasks.swift
//  Week 3 Tasks
